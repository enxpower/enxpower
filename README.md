...
<p align="center">
  <a href="https://enxpower.com/gong-vi/" aria-label="Gong Tiejing Personal Visual Identity">
    <img src="./assets/profile-hero.svg" width="100%" alt="Gong Tiejing — Founder and Systems Architect" />
  </a>
</p>

<p align="center"><samp>PRECISION · STRUCTURE · CONTINUITY · AUTHORITY</samp></p>
...
<table>
  <tr>
    <td width="25%"><samp>PRECISION</samp><br><sub>Clear requirements, measurable behavior, controlled interfaces.</sub></td>
    <td width="25%"><samp>STRUCTURE</samp><br><sub>Architecture that remains understandable as systems grow.</sub></td>
    <td width="25%"><samp>CONTINUITY</samp><br><sub>Products, documentation, and operations designed to endure.</sub></td>
    <td width="25%"><samp>AUTHORITY</samp><br><sub>Decisions grounded in engineering evidence and accountability.</sub></td>
  </tr>
</table>
